        ...
        extends Activity
{
  ...
  {
    NUL(0),  SOH(1),  STX(2),  ETX(3),  EOT(4),  ENQ(5),  ACK(6),  BEL(7),  BS(8),  HT(9),  LF(10),  VT(11),  FF(12),  CR(13),  SO(14),  SI(15),  DLE(16),  DC1(17),  DC2(18),  DC3(19),  DC4(20),  NAK(21),  SYN(22),  ETB(23),  CAN(24),  EM(25),  SUB(26),  ESC(27),  FS(28),  GS(29),  RS(30),  US(31);
  ...
  {
    RSTATE_SINGLE,  RSTATE_INKSTATUS,  RSTATE_EXTSTATUS,  RSTATE_ASB,  RSTATE_BLOCK_HEXADECIMAL,  RSTATE_BLOCK_BINARY,  RSTATE_RESERVED,  RSTATE_WAVEFORM,  RSTATE_EJDATA;
  }
